...
int16_t Yaw_Can_Set_Current = 0, Pitch_Can_Set_Current = 0, Push_Can_Set_Current = 0,Shoot_Can_Set_Current = 0;
...
//            }
//        }
				CAN_CMD_GIMBAL(Yaw_Can_Set_Current, Pitch_Can_Set_Current, Shoot_Can_Set_Current, Push_Can_Set_Current );
